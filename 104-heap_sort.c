...
/**
 * maxHeapify - The main funct to heapify a Max Heap. The funct
 * assumes that everything under given root (element at index idex)
...
/**
 * heap_sort -  The main funct to sort an array of given size
 * @array: array to sort
...
void heap_sort(int *array, size_t size)
{
	...
	/**
	* Repeats following steps while heap size is greater than 1.
